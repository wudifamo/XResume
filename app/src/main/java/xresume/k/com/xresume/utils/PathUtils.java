...
public final class PathUtils {
     ...
     * @return the path
     */
    private static Path createBubble(int width, int height, int quadCount, int wobbleRange,
     ...
     */
    @NonNull
    private static Path createCubicSpline(ArrayList<BezierPoint> points, @FloatRange(from = 0, to = 1) float intensity) {
        Path path = new Path();
